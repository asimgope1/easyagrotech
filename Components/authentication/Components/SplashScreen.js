    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#fff", justifyContent: "space-between", alignItems: "center" }}>
        <View style={{ height: "30%", width: "100%", }}>
          <Image source={require('../../Images/headereasy.png')} style={{ height: "70%", width: "100%" }} />
        </View>
        <View style={{ height: "20%", width: "100%", backgroundColor: "white", justifyContent: "center", alignItems: "center" }}>
          <Image source={require('../../Images/logoeasy.png')} style={{ height: 90, width: 300 }} />
        </View>
        <View style={{ height: "20%", width: "100%" }}>
          <Image source={require('../../Images/footereasy.png')} style={{ height: "100%", width: "100%" }} />
        </View>
      </View>
    )
  }
