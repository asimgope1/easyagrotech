...
const imagePath =
  item1 && item1.curr_state && item1.curr_state[19] === 1
...
class ThingDetails extends Component {
  ...
  connectWebSocket = () => {
    ...
    if (
      things[this.props.currentIndex] &&
      things[this.props.currentIndex].thing_id
    ) {
      this.WEBSOCKET_URL = `${ws_baseurl}/thing/r/${
        things[this.props.currentIndex].thing_id
      }/`;
  ...
  render() {
    ...
    const {thing_details} = this.state; // Access thing_details from state
    // Check if thing_details has data
    const hasData =
      thing_details &&
      ((thing_details.curr_state && thing_details.curr_state.length > 0) ||
        (thing_details.thing_schema && thing_details.thing_schema.length > 0));

    const combinedData =
      thingSchema.length > 0 &&
      thingSchema.reduce((acc, schemaItem, index) => {
    ...
    const deviceList = [
      {
        ...
        image2: (
          <View
            ...
            <Image
              source={require('../../Images/cooling-fan.png')}
        ...
        button2:
          item1 && item1.curr_state && item1.curr_state[16] == 1 ? (
            <Image
              source={require('../../Images/on.png')}
              style={{height: 30, width: 30}}
            />
      ...
      },
      {
        ...
        button1: (
          <Image
            source={
              item1 && item1.curr_state && item1.curr_state[20] == 1
                ? require('../../Images/on.png')
                : require('../../Images/off.png')
            }
            style={{height: 30, width: 30}}
        ...
        image2: (
          <View
            ...
            <Image
              source={require('../../Images/heater2.png')}
              style={{height: 23, width: 23, marginLeft: 10, marginRight: 7}}
            />
            <Text
              style={{
        ...
        button2: (
          <Image
            source={
              item1 && item1.curr_state && item1.curr_state[15] == 1
                ? require('../../Images/on.png')
                : require('../../Images/off.png')
            }
            style={{height: 30, width: 30}}
      ...
      },
      {
        image1: (
          <View
            ...
            <Image
              source={require('../../Images/crossvent.png')}
              style={{height: 23, width: 23, marginLeft: 10, marginRight: 7}}
            />
            <Text
              style={{
        ...
        button1: (
          <Image
            source={
              item1 && item1.curr_state && item1.curr_state[18] == 1
                ? require('../../Images/on.png')
                : require('../../Images/off.png')
            }
            style={{height: 30, width: 30}}
        ...
        image2: (
          <View
            ...
            <Image
              source={require('../../Images/fan5.png')}
              style={{height: 23, width: 23, marginLeft: 10, marginRight: 7}}
            />
            <Text
              style={{
        ...
        button2: (
          <Text
            ...
            {item1 && item1.curr_state && item1.curr_state[21] == 1
              ? 'AUTO'
              : 'MANUAL'}
          </Text>
        ),
      },
      {
        ...
        button1: (
          <Image
            source={
              item1 && item1.curr_state && item1.curr_state[52] == 1
                ? require('../../Images/on.png')
                : require('../../Images/off.png')
            }
            style={{height: 30, width: 30}}
        ...
        image2: (
          <View
            ...
            <Image
              source={require('../../Images/fog1.png')}
              style={{height: 23, width: 23, marginLeft: 10, marginRight: 7}}
            />
            <Text
              style={{
        ...
        button2: (
          <Image
            source={
              item1 && item1.curr_state && item1.curr_state[46] == 1
                ? require('../../Images/on.png')
                : require('../../Images/off.png')
            }
            style={{height: 30, width: 30}}
        ...
        <View>
            ...
            <Modal
              ...
              <View style={styles.centeredView}>
                <View style={styles.indicator}>
                  ...
                  <Text>Waiting For The Response</Text>
                </View>
              </View>
            </Modal>
          )}
          ...
          <View
            ...
            <Text
              ...
              {this.props.thing_details.thing_name}
            </Text>
            <Text
              style={{
                fontSize: 15,
              ...
              {this.props.thing_details.timestamp &&
                this.props.thing_details.timestamp.split('T')[0]}
            </Text>
            <Text
              style={{
                fontSize: 15,
              ...
              {this.props.thing_details.timestamp &&
                this.props.thing_details.timestamp.split('T')[1]}
            </Text>
          </View>
          <View
            style={{
              ...
              {hasData &&
                ['Main', 'Device', 'Flock'].map((item, index) => (
                  <TouchableOpacity
                    key={index}
                    onPress={() => {
                      this.setState({currentViewType: item});
                    }}
                    style={{
                      borderRadius: 10,
                      backgroundColor:
                        this.state.currentViewType === item ? 'green' : '#fff',
                      height: 40,
                      width: 100,
                      margin: 15,
                      shadowColor: '#000000',
                    ...
                    <Text
                      style={{
                        ...
                        fontSize: 11,
                        color:
                          this.state.currentViewType === item
                            ? '#fff'
                            : 'green',
                        textAlign: 'center',
                      }}>
          ...
          <ScrollView style={{height: HEIGHT / 1.6}}>
            {this.state.currentViewType == 'Main' ? (
                      ...
                      <View
                        ...
                        <View>
                          ...
                          <Text
                            ...
                            {this.state.thing_details.curr_state &&
                            this.state.thing_details.curr_state[0] < 0
                              ? '+++'
                              : this.state.thing_details.curr_state &&
                                this.state.thing_details.curr_state[0]}
                            {this.state.thing_details.thing_schema &&
                              this.state.thing_details.thing_schema[0] &&
                              this.state.thing_details.thing_schema[0].unit}
                          </Text>
                          <View
                            style={{
                              display: 'flex',
                            ...
                            <Text
                              ...
                              Req-Temp-
                              {this.state.thing_details.curr_state &&
                                this.state.thing_details.curr_state[29]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[29] &&
                                this.state.thing_details.thing_schema[29].unit}
                            </Text>
                          ...
                          <View>
                            <Text
                              ...
                              Outside-Temp-
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[5] < 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[5]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[5] &&
                                this.state.thing_details.thing_schema[2].unit}
                            </Text>
                          </View>
                        </View>
                      </View>
                        ...
                        <View
                          ...
                          <View>
                            ...
                            <Text
                              ...
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[1] < 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[1]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[1] &&
                                this.state.thing_details.thing_schema[1].unit}
                            </Text>
                          </View>
                          <View>
                            <Text
                            ...
                            <Text style={{padding: 7}}>
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[3] < 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[3]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[3] &&
                                this.state.thing_details.thing_schema[3].unit}
                            </Text>
                          </View>
                        </View>
                        <View
                          ...
                          <View>
                            ...
                            <Text
                              ...
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[2] < 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[2]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[2] &&
                                this.state.thing_details.thing_schema[2].unit}
                            </Text>
                          </View>
                          <View>
                            ...
                            <Text style={{padding: 7}}>
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[4] < 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[4]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[4] &&
                                this.state.thing_details.thing_schema[4].unit}
                            </Text>
                          </View>
                        </View>
                      </View>
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      ...
                      <View style={{marginLeft: 10}}>
                        ...
                        <Text
                          ...
                          {this.state.thing_details.curr_state &&
                          this.state.thing_details.curr_state[6] <= 0
                            ? '+++'
                            : this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[6]}
                          {this.state.thing_details.thing_schema &&
                            this.state.thing_details.thing_schema[6] &&
                            this.state.thing_details.thing_schema[6].unit}
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={{alignItems: 'flex-end'}}>
                      <View
                        ...
                        <Text
                          ...
                          {this.state.thing_details.curr_state &&
                            this.state.thing_details.curr_state[30]}
                          {this.state.thing_details.thing_schema &&
                            this.state.thing_details.thing_schema[30] &&
                            this.state.thing_details.thing_schema[30].unit}
                        </Text>
                      </View>
                    </View>
                  </View>
                        ...
                        <View
                          ...
                          <View>
                            ...
                            <Text
                              ...
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[7] <= 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[7]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[7] &&
                                this.state.thing_details.thing_schema[7].unit}
                            </Text>
                          </View>
                        </View>
                      </View>
                        ...
                        <View
                          ...
                          <View>
                            ...
                            <Text
                              ...
                              {this.state.thing_details.curr_state &&
                              this.state.thing_details.curr_state[8] <= 0
                                ? '+++'
                                : this.state.thing_details.curr_state &&
                                  this.state.thing_details.curr_state[8]}
                              {this.state.thing_details.thing_schema &&
                                this.state.thing_details.thing_schema[8] &&
                                this.state.thing_details.thing_schema[8].unit}
                            </Text>
                            {/* <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-evenly", borderRadius: 10, backgroundColor: "skyblue", width: 70, marginTop: 5 }}>
                    ...
                    <View
                      ...
                      <View>
                        ...
                        <Image
                          source={
                            this.state.thing_details.curr_state &&
                            this.state.thing_details.curr_state[43] == 1
                              ? require('../../Images/fan.gif')
                              : require('../../Images/fan5.png')
                          }
                      ...
                      <View>
                        ...
                        <Image
                          source={
                            this.state.thing_details.curr_state &&
                            this.state.thing_details.curr_state[43] == 0
                              ? require('../../Images/fan.gif')
                              : require('../../Images/fan5.png')
                          }
                          style={{height: 60, width: 60, marginLeft: '10%'}}
                            ...
                            return (
                              <View
                                ...
                                style={{
                                  ...
                                  display: 'flex',
                                  alignItems: 'center',
                                  borderRightWidth: index == 1 ? 0.5 : 0,
                                  borderColor: '#fff',
                                }}>
                                <Text
                                  style={{
              ...
              this.state?.thing_details !== '{}' ? (
              <Devices thing_details={this.state?.thing_details} />
            ) : (
              <View>
                <Flock thing_details={this.state?.thing_details} />
              </View>
            )}
          </ScrollView>
        </View>
...
const mapDispatchToProps = dispatch => {
  return {
    getThingDetails: (accessToken, body) =>
      dispatch(getThingDetails(accessToken, body)),
  };
};
