...
import {userLogout} from '../../authentication/action';
            ...
            <View
              ...
              <View style={{marginTop: 20}}>
                <View style={styles.textInputBox}>
                  ...
                  <TextInput
                    defaultValue={
                      this.props.user_details.data &&
                      this.props.user_details.data.name
                    }
                ...
                <View style={styles.textInputBox}>
                  ...
                  <TextInput
                    value={
                      this.props.user_details.data &&
                      this.props.user_details.data.email
                    }
                ...
                <View style={styles.textInputBox}>
                  ...
                  <TextInput
                    defaultValue={
                      this.props.user_details.data &&
                      this.props.user_details.data.phone
                    }
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onUpdateProfile: (accessToken, body) =>
      dispatch(onUpdateProfile(accessToken, body)),
